...
/**
 * Check if WooCommerce is enabled via existence of class.
 */
function worksfront_is_woocommerce_activated() {
 ...
 */
function worksfront_do_shortcode( $tag, array $atts = array(), $content = null ) {
